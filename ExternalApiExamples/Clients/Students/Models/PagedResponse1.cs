...
namespace Kmd.Studica.Students.Client.Models
{
    ...
    public partial class PagedResponse1
    {
        ...
        /// Initializes a new instance of the PagedResponse1 class.
        /// </summary>
        public PagedResponse1(IList<StudentsResponse> items = default(IList<StudentsResponse>), int? totalItems = default(int?))
        {
            Items = items;
        ...
        public IList<StudentsResponse> Items { get; private set; }
