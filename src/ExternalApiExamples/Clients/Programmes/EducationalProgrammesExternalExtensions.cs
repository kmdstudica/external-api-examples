...
namespace Kmd.Studica.Programmes.Client
{
    ...
    public static partial class EducationalProgrammesExternalExtensions
    {
            ...
            /// </param>
            public static PagedResponse1EducationalProgrammeExternalResponse Get(this IEducationalProgrammesExternal operations, System.DateTime startDateFrom, System.DateTime startDateTo, string schoolCode, int pageNumber, int pageSize, bool inlineCount)
            {
            ...
            /// </param>
            public static async Task<PagedResponse1EducationalProgrammeExternalResponse> GetAsync(this IEducationalProgrammesExternal operations, System.DateTime startDateFrom, System.DateTime startDateTo, string schoolCode, int pageNumber, int pageSize, bool inlineCount, CancellationToken cancellationToken = default(CancellationToken))
            {
