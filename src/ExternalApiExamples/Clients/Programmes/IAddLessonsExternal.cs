...
namespace Kmd.Studica.Programmes.Client
{
    ...
    public partial interface IAddLessonsExternal
    {
        ...
        /// </exception>
        Task<HttpOperationResponse> PostWithHttpMessagesAsync(IList<NewLessonExternal> newLessons, string schoolCode, string xSelectedSchoolCode = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
