...
namespace Kmd.Studica.Programmes.Client
{
    ...
    public partial interface IAddSessionsToSubjectCoursesExternal
    {
        ...
        /// </exception>
        Task<HttpOperationResponse> PostWithHttpMessagesAsync(IList<ExternalSubjectCourseSessionDto> sessions, string schoolCode, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
