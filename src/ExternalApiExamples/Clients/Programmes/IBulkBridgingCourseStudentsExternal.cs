...
namespace Kmd.Studica.Programmes.Client
{
    ...
    public partial interface IBulkBridgingCourseStudentsExternal
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<IList<BridgingCourseStudentExternalResponse>>> PostWithHttpMessagesAsync(IList<System.Guid> studentIds, string schoolCode, string xSelectedSchoolCode = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
