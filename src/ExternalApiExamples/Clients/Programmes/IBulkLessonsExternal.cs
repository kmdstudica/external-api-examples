...
namespace Kmd.Studica.Programmes.Client
{
    ...
    public partial interface IBulkLessonsExternal
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<IList<LessonExternalResponse>>> PostWithHttpMessagesAsync(IList<System.Guid> lessonIds, string schoolCode, string xSelectedSchoolCode = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
