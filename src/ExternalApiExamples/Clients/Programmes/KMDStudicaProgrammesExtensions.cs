...
namespace Kmd.Studica.Programmes.Client
{
    ...
    public static partial class KMDStudicaProgrammesExtensions
    {
            ...
            /// <param name='body'>
            /// </param>
            public static bool? Post1(this IKMDStudicaProgrammes operations, AggregateExistsExternalRequest body = default(AggregateExistsExternalRequest))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<bool?> Post1Async(this IKMDStudicaProgrammes operations, AggregateExistsExternalRequest body = default(AggregateExistsExternalRequest), CancellationToken cancellationToken = default(CancellationToken))
            {
