...
namespace Kmd.Studica.Programmes.Client
{
    ...
    public static partial class LessonsExternalExtensions
    {
            ...
            /// </param>
            public static PagedResponseLessonExternalResponse Get(this ILessonsExternal operations, System.DateTime dateFrom, System.DateTime dateTo, int pageNumber, int pageSize, bool inlineCount, string schoolCode, System.Guid? departmentId = default(System.Guid?), bool? hasExternalId = default(bool?), string xSelectedSchoolCode = default(string))
            {
