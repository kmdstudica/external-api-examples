...
namespace Kmd.Studica.SchoolAdministration.Client
{
    ...
    public static partial class ActiveDepartmentsExternalExtensions
    {
            ...
            /// </param>
            public static PagedResponseDepartmentsExternalResponse Get(this IActiveDepartmentsExternal operations, int pageNumber, int pageSize, bool inlineCount, string schoolCode, string xSelectedSchoolCode = default(string))
            {
            ...
            /// </param>
            public static async Task<PagedResponseDepartmentsExternalResponse> GetAsync(this IActiveDepartmentsExternal operations, int pageNumber, int pageSize, bool inlineCount, string schoolCode, string xSelectedSchoolCode = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
