...
namespace Kmd.Studica.SchoolAdministration.Client
{
    ...
    public partial interface IBulkEmployeesExternal
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<IList<EmployeeExternalResponse>>> PostWithHttpMessagesAsync(IList<System.Guid> employeeIds, string schoolCode, string xSelectedSchoolCode = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
