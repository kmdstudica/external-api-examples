...
namespace Kmd.Studica.SchoolAdministration.Client.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Returns a paged list of areas of responsibility satisfying provided
    /// criteria.
    /// </remarks>
    public partial class AreasOfResponsibilityExternalRequest
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AreasOfResponsibilityExternalRequest class.
        /// </summary>
        public AreasOfResponsibilityExternalRequest()
        {
            CustomInit();
        }
        ...
        /// data.</param>
        public AreasOfResponsibilityExternalRequest(int pageNumber, int pageSize, bool inlineCount, string schoolCode)
        {
