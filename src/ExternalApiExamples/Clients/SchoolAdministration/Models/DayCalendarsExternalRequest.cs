...
namespace Kmd.Studica.SchoolAdministration.Client.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Returns a paged list of day calendars satisfying provided criteria.
    /// </remarks>
    public partial class DayCalendarsExternalRequest
    {
        /// <summary>
        /// Initializes a new instance of the DayCalendarsExternalRequest
        /// class.
        /// </summary>
        public DayCalendarsExternalRequest()
        {
            CustomInit();
        }
        ...
        public DayCalendarsExternalRequest(string schoolCode, int pageNumber, int pageSize, bool inlineCount)
        {
