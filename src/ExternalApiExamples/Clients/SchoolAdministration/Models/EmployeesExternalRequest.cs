...
namespace Kmd.Studica.SchoolAdministration.Client.Models
{
    ...
    public partial class EmployeesExternalRequest
    {
        ...
        public EmployeesExternalRequest(System.DateTime employmentStartDateFrom, System.DateTime employmentStartDateTo, string schoolCode, int pageNumber, int pageSize, bool inlineCount)
        {
