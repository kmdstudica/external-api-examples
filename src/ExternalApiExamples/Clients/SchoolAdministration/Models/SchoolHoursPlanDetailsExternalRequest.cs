...
namespace Kmd.Studica.SchoolAdministration.Client.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Returns a details school hours plan containing
    /// start and end times of the individual entries
    /// </remarks>
    public partial class SchoolHoursPlanDetailsExternalRequest
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SchoolHoursPlanDetailsExternalRequest class.
        /// </summary>
        public SchoolHoursPlanDetailsExternalRequest()
        {
            CustomInit();
        }
        ...
        public SchoolHoursPlanDetailsExternalRequest(System.Guid id, string schoolCode)
        {
            Id = id;
