...
namespace Kmd.Studica.SchoolAdministration.Client
{
    ...
    public static partial class SchoolHoursPlansExternalExtensions
    {
            ...
            /// </param>
            public static PagedResponseSchoolHoursPlanExternalResponse Get(this ISchoolHoursPlansExternal operations, int pageNumber, int pageSize, bool inlineCount, string schoolCode, string xSelectedSchoolCode = default(string))
            {
            ...
            /// </param>
            public static async Task<PagedResponseSchoolHoursPlanExternalResponse> GetAsync(this ISchoolHoursPlansExternal operations, int pageNumber, int pageSize, bool inlineCount, string schoolCode, string xSelectedSchoolCode = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
