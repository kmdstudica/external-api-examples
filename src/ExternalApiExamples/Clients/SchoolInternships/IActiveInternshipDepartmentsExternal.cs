...
namespace Kmd.Studica.SchoolInternships.Client
{
    ...
    public partial interface IActiveInternshipDepartmentsExternal
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<PagedResponseInternshipDepartmentsExternalResponse>> GetWithHttpMessagesAsync(int pageNumber, int pageSize, bool inlineCount, string schoolCode, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
