...
namespace Kmd.Studica.SchoolInternships.Client.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Get a list of all the school's active internship departments.
    /// </remarks>
    public partial class ActiveInternshipDepartmentsExternalRequest
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ActiveInternshipDepartmentsExternalRequest class.
        /// </summary>
        public ActiveInternshipDepartmentsExternalRequest()
        {
            CustomInit();
        }
        ...
        public ActiveInternshipDepartmentsExternalRequest(int pageNumber, int pageSize, bool inlineCount, string schoolCode)
        {
