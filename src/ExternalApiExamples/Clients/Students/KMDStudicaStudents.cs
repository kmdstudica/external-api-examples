...
namespace Kmd.Studica.Students.Client
{
    ...
    public partial class KMDStudicaStudents : ServiceClient<KMDStudicaStudents>, IKMDStudicaStudents
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<bool?>> PostWithHttpMessagesAsync(AggregateExistsExternalRequest body = default(AggregateExistsExternalRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (body != null)
            {
                body.Validate();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<PagedResponseStudentExternalResponse>> Post1WithHttpMessagesAsync(StudentsExternalRequest body = default(StudentsExternalRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (body != null)
            {
                body.Validate();
