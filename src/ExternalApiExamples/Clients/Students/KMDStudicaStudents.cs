...
namespace Kmd.Studica.Students.Client
{
    ...
    public partial class KMDStudicaStudents : ServiceClient<KMDStudicaStudents>, IKMDStudicaStudents
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<PagedResponseStudentExternalResponse>> PostWithHttpMessagesAsync(StudentsExternalRequest body = default(StudentsExternalRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (body != null)
            {
                body.Validate();
